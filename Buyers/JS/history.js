// history.js - Buyer-focused: Only PR-related activities
...
// Only PR-related activity types
...
async function loadActivities(append = false) {
  ...
  try {
    ...
    // Only keep PR-related activities
    activities = activities.filter((a) =>
      activityConfig.hasOwnProperty(a.activity_type),
    );
...
function createTimelineItem(activity) {
  ...
  item.innerHTML = `
    ...
    <div class="timeline-content ${clickableClass}" data-activity-id="${activity.id}">
      ...
      ${activity.details ? `<small>${activity.details.substring(0, 120)}${activity.details.length > 120 ? "..." : ""}</small>` : ""}
    ...
    <div class="modal-detail-wrapper">
      ...
      <div class="modal-info-grid">
        <div class="modal-info-item">
          ...
          <span class="modal-value">${activity.performed_by || "Finance System"}</span>
        </div>
